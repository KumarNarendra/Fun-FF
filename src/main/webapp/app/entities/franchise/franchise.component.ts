...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/franchise'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    registerChangeInFranchises() {
        this.eventSubscriber = this.eventManager.subscribe('franchiseListModification', (response) => this.loadAll());
    }
