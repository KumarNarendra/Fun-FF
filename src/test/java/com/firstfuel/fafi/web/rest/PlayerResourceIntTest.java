...
public class PlayerResourceIntTest {
    ...
    public void createPlayer()
        ...
        restPlayerMockMvc.perform( post( "/api/players" ).contentType( TestUtil.APPLICATION_JSON_UTF8 ).content( TestUtil.convertObjectToJsonBytes( playerDTO ) ) )
    ...
    @Test
    @Transactional
    public void createPlayerWithExistingId()
        throws Exception {
        int databaseSizeBeforeCreate = playerRepository.findAll().size();
    ...
    @Test
    @Transactional
    public void getAllPlayersByNameIsEqualToSomething()
        throws Exception {
        // Initialize the database
        playerRepository.saveAndFlush( player );
    ...
    @Test
    @Transactional
    public void getAllPlayersByNameIsInShouldWork()
        throws Exception {
        // Initialize the database
        playerRepository.saveAndFlush( player );
    ...
    @Test
    @Transactional
    public void getAllPlayersByNameIsNullOrNotNull()
        throws Exception {
        // Initialize the database
        playerRepository.saveAndFlush( player );
    ...
    @Test
    @Transactional
    public void getAllPlayersByBasePriceIsEqualToSomething()
        throws Exception {
        // Initialize the database
        playerRepository.saveAndFlush( player );
    ...
    @Test
    @Transactional
    public void getAllPlayersByBasePriceIsInShouldWork()
        throws Exception {
        // Initialize the database
        playerRepository.saveAndFlush( player );
    ...
    @Test
    @Transactional
    public void getAllPlayersByBasePriceIsNullOrNotNull()
        throws Exception {
        // Initialize the database
        playerRepository.saveAndFlush( player );
    ...
    @Test
    @Transactional
    public void getAllPlayersByBidPriceIsEqualToSomething()
        throws Exception {
        // Initialize the database
        playerRepository.saveAndFlush( player );
    ...
    @Test
    @Transactional
    public void getAllPlayersByBidPriceIsInShouldWork()
        throws Exception {
        // Initialize the database
        playerRepository.saveAndFlush( player );
    ...
    @Test
    @Transactional
    public void getAllPlayersByBidPriceIsNullOrNotNull()
        throws Exception {
        // Initialize the database
        playerRepository.saveAndFlush( player );
    ...
    @Test
    @Transactional
    public void getAllPlayersByOptedGamesIsEqualToSomething()
        throws Exception {
        // Initialize the database
        playerRepository.saveAndFlush( player );
    ...
    @Test
    @Transactional
    public void getAllPlayersByOptedGamesIsInShouldWork()
        throws Exception {
        // Initialize the database
        playerRepository.saveAndFlush( player );
    ...
    @Test
    @Transactional
    public void getAllPlayersByOptedGamesIsNullOrNotNull()
        throws Exception {
        // Initialize the database
        playerRepository.saveAndFlush( player );
     ...
     */
    private void defaultPlayerShouldBeFound( String filter )
        throws Exception {
     ...
     */
    private void defaultPlayerShouldNotBeFound( String filter )
        throws Exception {
        restPlayerMockMvc.perform( get( "/api/players?sort=id,desc&" + filter ) )
            .andExpect( status().isOk() )
            .andExpect( content().contentType( MediaType.APPLICATION_JSON_UTF8_VALUE ) )
    ...
    public void getNonExistingPlayer()
        throws Exception {
        // Get the player
        restPlayerMockMvc.perform( get( "/api/players/{id}", Long.MAX_VALUE ) ).andExpect( status().isNotFound() );
    }
    ...
    public void deletePlayer()
        ...
        // Get the player
        restPlayerMockMvc.perform( delete( "/api/players/{id}", player.getId() ).accept( TestUtil.APPLICATION_JSON_UTF8 ) ).andExpect( status().isOk() );
