...
public class MatchResourceIntTest {
    ...
    public static Match createEntity( EntityManager em ) {
        Match match = new Match().startDateTime( DEFAULT_START_DATE_TIME )
    ...
    public void createMatch()
        ...
        restMatchMockMvc.perform( post( "/api/matches" ).contentType( TestUtil.APPLICATION_JSON_UTF8 ).content( TestUtil.convertObjectToJsonBytes( matchDTO ) ) )
    ...
    @Test
    @Transactional
    public void createMatchWithExistingId()
        throws Exception {
        int databaseSizeBeforeCreate = matchRepository.findAll().size();
    ...
    @Test
    @Transactional
    public void getAllMatchesByStartDateTimeIsEqualToSomething()
        throws Exception {
        // Initialize the database
        matchRepository.saveAndFlush( match );
    ...
    @Test
    @Transactional
    public void getAllMatchesByStartDateTimeIsInShouldWork()
        throws Exception {
        // Initialize the database
        matchRepository.saveAndFlush( match );
    ...
    @Test
    @Transactional
    public void getAllMatchesByStartDateTimeIsNullOrNotNull()
        throws Exception {
        // Initialize the database
        matchRepository.saveAndFlush( match );
    ...
    @Test
    @Transactional
    public void getAllMatchesByStartDateTimeIsGreaterThanOrEqualToSomething()
        throws Exception {
        // Initialize the database
        matchRepository.saveAndFlush( match );
    ...
    @Test
    @Transactional
    public void getAllMatchesByStartDateTimeIsLessThanSomething()
        throws Exception {
        // Initialize the database
        matchRepository.saveAndFlush( match );
    ...
    @Test
    @Transactional
    public void getAllMatchesByEndDateTimeIsEqualToSomething()
        throws Exception {
        // Initialize the database
        matchRepository.saveAndFlush( match );
    ...
    @Test
    @Transactional
    public void getAllMatchesByEndDateTimeIsInShouldWork()
        throws Exception {
        // Initialize the database
        matchRepository.saveAndFlush( match );
    ...
    @Test
    @Transactional
    public void getAllMatchesByEndDateTimeIsNullOrNotNull()
        throws Exception {
        // Initialize the database
        matchRepository.saveAndFlush( match );
    ...
    @Test
    @Transactional
    public void getAllMatchesByEndDateTimeIsGreaterThanOrEqualToSomething()
        throws Exception {
        // Initialize the database
        matchRepository.saveAndFlush( match );
    ...
    @Test
    @Transactional
    public void getAllMatchesByEndDateTimeIsLessThanSomething()
        throws Exception {
        // Initialize the database
        matchRepository.saveAndFlush( match );
    ...
    @Test
    @Transactional
    public void getAllMatchesByPointsForFranchise1IsEqualToSomething()
        throws Exception {
        // Initialize the database
        matchRepository.saveAndFlush( match );
    ...
    @Test
    @Transactional
    public void getAllMatchesByPointsForFranchise1IsInShouldWork()
        throws Exception {
        // Initialize the database
        matchRepository.saveAndFlush( match );
    ...
    @Test
    @Transactional
    public void getAllMatchesByPointsForFranchise1IsNullOrNotNull()
        throws Exception {
        // Initialize the database
        matchRepository.saveAndFlush( match );
    ...
    @Test
    @Transactional
    public void getAllMatchesByPointsForFranchise2IsEqualToSomething()
        throws Exception {
        // Initialize the database
        matchRepository.saveAndFlush( match );
    ...
    @Test
    @Transactional
    public void getAllMatchesByPointsForFranchise2IsInShouldWork()
        throws Exception {
        // Initialize the database
        matchRepository.saveAndFlush( match );
    ...
    @Test
    @Transactional
    public void getAllMatchesByPointsForFranchise2IsNullOrNotNull()
        throws Exception {
        // Initialize the database
        matchRepository.saveAndFlush( match );
    ...
    @Test
    @Transactional
    public void getAllMatchesByTournamentIsEqualToSomething()
        throws Exception {
        // Initialize the database
    ...
    @Test
    @Transactional
    public void getAllMatchesByFranchise1IsEqualToSomething()
        throws Exception {
        // Initialize the database
    ...
    @Test
    @Transactional
    public void getAllMatchesByFranchise2IsEqualToSomething()
        throws Exception {
        // Initialize the database
    ...
    @Test
    @Transactional
    public void getAllMatchesByWinnerIsEqualToSomething()
        throws Exception {
        // Initialize the database
     ...
     */
    private void defaultMatchShouldBeFound( String filter )
        throws Exception {
     ...
     */
    private void defaultMatchShouldNotBeFound( String filter )
        throws Exception {
        restMatchMockMvc.perform( get( "/api/matches?sort=id,desc&" + filter ) )
            .andExpect( status().isOk() )
            .andExpect( content().contentType( MediaType.APPLICATION_JSON_UTF8_VALUE ) )
    ...
    public void getNonExistingMatch()
        throws Exception {
        // Get the match
        restMatchMockMvc.perform( get( "/api/matches/{id}", Long.MAX_VALUE ) ).andExpect( status().isNotFound() );
    }
    ...
    public void updateMatch()
        ...
        updatedMatch.startDateTime( UPDATED_START_DATE_TIME )
        ...
        restMatchMockMvc.perform( put( "/api/matches" ).contentType( TestUtil.APPLICATION_JSON_UTF8 ).content( TestUtil.convertObjectToJsonBytes( matchDTO ) ) )
            .andExpect( status().isOk() );
    ...
    @Test
    @Transactional
    public void updateNonExistingMatch()
        throws Exception {
        int databaseSizeBeforeUpdate = matchRepository.findAll().size();
    ...
    public void deleteMatch()
        ...
        // Get the match
        restMatchMockMvc.perform( delete( "/api/matches/{id}", match.getId() ).accept( TestUtil.APPLICATION_JSON_UTF8 ) ).andExpect( status().isOk() );
